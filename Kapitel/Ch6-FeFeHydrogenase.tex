...
\end{tabular}
\begin{flushleft}\footnotesize{$^\dagger$ From DFT calculations of Ref.~[6.\kern-0.4em\citenum{GrecoDFT}], we assume the majority of the spin is located on Fe$_d$; however, significant $^{57}$Fe hyperfine interactions on both irons are measured by Silakov {\em et al.} in Ref.~[6.\kern-0.4em\citenum{Silakov57Fe}].} \end{flushleft}
...
\end{tabular}
\begin{flushleft}\footnotesize{$^\ddagger$ Data is obtained from Adamska {\em et al.} of Ref.~[6.\kern-0.4em\citenum{Adamska2015}]. Other groups, such as Britt and colleagues in Ref.~[6.\kern-0.4em\citenum{BrittLigands2014}] have obtained similar values; however, Adamska {\em et al.} use the same molecular frame described in this work. 

$^{\S}$ Data is obtained from Adamska {\em et al.} of Ref.~[6.\kern-0.4em\citenum{Adamska2015pdt}]. }\end{flushleft}
...
$^{\ast\ast}$ Data is obtained from Britt {\em et al.} of Ref.~[6.\kern-0.4em\citenum{BrittC13}].
