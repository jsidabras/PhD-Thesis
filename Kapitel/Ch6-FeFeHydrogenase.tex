...
The first [FeFe]-hydrogenase is colored red in Fig.~\ref{fig:xTalFeFeUnit}. The H-cluster of this [FeFe]-hydrogenase serves the basis for the first molecular-frame (Molecular-Frame A). A second molecular-frame (Molecular-Frame B) is needed since the [FeFe]-hydrogenase is crystallized with an asymmetric unit, shown colored blue in Fig.~\ref{fig:xTalFeFeUnit}. Molecular-Frame B is defined by the same procedure as the Molecular-Frame A, but at the origin of the distal iron in the H-cluster of protein B.
...
The deviation of the frozen solution projection of Adamska \textit{et al.} compared to the single-crystal measurement is due to the frozen solution data being under-determined. Further analysis and refinement is possible with the collection of hyperfine and quadrupole data originating from the same crystal and relating the whole dataset to quantum chemical calculations.
